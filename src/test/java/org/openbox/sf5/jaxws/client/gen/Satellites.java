...
public interface Satellites {
    ...
    @Action(input = "http://sf5.openbox.org/satelliteservice/1.0/Satellites/getAllSatellitesRequest", output = "http://sf5.openbox.org/satelliteservice/1.0/Satellites/getAllSatellitesResponse")
    ...
    @Action(input = "http://sf5.openbox.org/satelliteservice/1.0/Satellites/getSatelliteByIdRequest", output = "http://sf5.openbox.org/satelliteservice/1.0/Satellites/getSatelliteByIdResponse")
    ...
    @Action(input = "http://sf5.openbox.org/satelliteservice/1.0/Satellites/getSatellitesByArbitraryFilterRequest", output = "http://sf5.openbox.org/satelliteservice/1.0/Satellites/getSatellitesByArbitraryFilterResponse")
